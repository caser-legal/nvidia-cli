...
- iOS Projects: ${process.env.HOME || ""}/Documents/iOS/
- MASTER Blueprint: ${process.env.HOME || ""}/Documents/iOS/dev-docs/MASTER.md
- Design System: ${process.env.HOME || ""}/Documents/iOS/dev-docs/guides/design-system.md
- nvidia-cli: ${process.env.HOME || ""}/Documents/nvidia-cli/
